...
# consonant clusters that should be kept together, following Karlsson 1985: (4)
CLUSTERS = set(['bl', 'br', 'dr', 'fl', 'fr', 'gl', 'gr', 'kl',
               'kr', 'kv', 'pl', 'pr', 'cl', 'qv', 'schm'])
CLUSTER_LENGTHS = set(len(cluster) for cluster in CLUSTERS)

# sets of Finnish vowels, diphthongs, and consonants
VOWELS = set(['i', 'e', 'ä', 'y', 'ö', 'a', 'u', 'o'])
DIPHTHONGS = set(['ai', 'ei', 'oi', 'äi', 'öi', 'au', 'eu', 'ou',
                 'ey', 'äy', 'öy', 'ui', 'yi', 'iu', 'iy', 'ie', 'uo', 'yö'])
CONSONANTS = set(['b', 'c', 'd', 'f', 'g', 'h', 'j', 'k', 'l', 'm', 'n', 'p', 'q',
                 'r', 's', 't', 'v', 'x', 'z', "'"])  # ' included for purposes of words like vaa'an
...
def split_syllable(syllable):
    ...
    nucleus_start = i
    # store onset (composed of consonants)
    ...
    coda_start = i
    # store nucleus (composed of vowels)
