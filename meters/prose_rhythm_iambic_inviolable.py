...
name = "Prose Rhythm Class, Iambic Meter, with Inviolable Constraints"
#
...
# require a rising rhythm (e.g., iambic, anapestic)
Cs['headedness!=rising'] = 1000
#
############################################
...
#
# Constraint weights are divided by the numeric value; so if phrasally stressed syllables
# are prohibited, and that constraint's weight is "10", and the violating word has a phrasal
# stress value of 2 (secondary stress), then the resulting violation score would be 10 / 2 = 5.
#
###
